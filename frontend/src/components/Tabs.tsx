...
const variantStyles: Record<TabsVariant, { list: string; tab: string; activeTab: string }> = {
  default: {
    list: 'border-b border-gray-700/40',
    tab: 'border-b-2 border-transparent text-gray-400 hover:text-white hover:border-purple-500/50 transition-all duration-200',
    activeTab: 'border-purple-500 text-white font-medium',
  },
  pills: {
    list: 'bg-gray-800/50 rounded-xl p-1.5 border border-gray-700/50 gap-1',
    tab: 'rounded-lg text-gray-400 hover:text-white hover:bg-gray-700/60 transition-all duration-200',
    activeTab: 'bg-gradient-to-r from-purple-600 to-purple-500 text-white shadow-lg shadow-purple-500/30',
  },
  underline: {
    list: '',
    tab: 'text-gray-400 hover:text-white relative after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-transparent hover:after:bg-gray-700/50 hover:after:scale-x-100 after:scale-x-0 after:transition-transform duration-200',
    activeTab: 'text-purple-300 after:bg-gradient-to-r after:from-purple-500 after:to-pink-500 after:scale-x-100 font-medium',
  },
  enclosed: {
    list: 'border-b border-gray-700/50 gap-1',
    tab: 'border border-transparent rounded-t-lg text-gray-400 hover:text-white hover:bg-gray-800/60 -mb-px transition-all duration-200',
    activeTab: 'bg-gradient-to-b from-gray-700 to-gray-800 border border-gray-700/50 border-b-gray-800 text-white font-medium',
  },
};
